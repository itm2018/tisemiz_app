				...
				<div class="row">
					...
					<div class="col-md-2 left-sidebar">
						...
						<nav class="main-nav">
							...
							<ul class="main-menu">
								<li class="active"><a href="index.html"><i class="fa fa-dashboard fa-fw"></i><span class="text">Trang qu?n tr?</span></a>
								</li>
								<li><a href="#" class="js-sub-menu-toggle"><i class="fa fa-clipboard fa-fw"></i><span class="text">Khu công nghi?p</span>
									<i class="toggle-icon fa fa-angle-left"></i></a>
									<ul class="sub-menu ">
										<li>
											<a href="ql-kcn.html">
												<span class="text">Qu?n lý</span>
											</a>
										</li>
										<li>
											<a href="add-kcn.html">
												<span class="text">Thêm m?i</span>
											</a>
										</li>
									</ul>
								</li>
								<li><a href="#" class="js-sub-menu-toggle"><i class="fa fa-clipboard fa-fw"></i><span class="text">Doanh nghi?p</span>
									<i class="toggle-icon fa fa-angle-left"></i></a>
									<ul class="sub-menu ">
										<li>
											<a href="<?php echo $this->Html->url('/admin/doanhnghiep/lietke');?>">
												<span class="text">Li?t kê</span>
											</a>
										</li>
										<li>
											<a href="add-doanhnghiep.html">
												<span class="text">Thêm m?i</span>
											</a>
										</li>
									</ul>
								</li>
                                <li><a href="#" class="js-sub-menu-toggle"><i class="fa fa-clipboard fa-fw"></i><span class="text">Ho?t d?ng môi tru?ng</span>
                                    <i class="toggle-icon fa fa-angle-left"></i></a>
                                    <ul class="sub-menu ">
                                        <li>
                                            <a href="nhapsolieu.html">
                                                <span class="text">Nh?p s? li?u di?u tra</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="xuatbieudo.html">
                                                <span class="text">Xu?t bi?u d?</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="js-sub-menu-toggle"><i class="fa fa-clipboard fa-fw"></i><span class="text">Th?ng kê</span>
                                    <i class="toggle-icon fa fa-angle-left"></i></a>
                                    <ul class="sub-menu ">
                                        <li>
                                            <a href="thongke1.html">
                                                <span class="text">Doanh nghi?p theo khu công nghi?p</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="thongke2.html">
                                                <span class="text">Ho?t d?ng b?o v? môi tru?ng c?a doanh nghi?p</span>
                                            </a>
                                        </li>
                                     </ul>
                                </li>
                                <li><a href="#" class="js-sub-menu-toggle"><i class="fa fa-clipboard fa-fw"></i><span class="text">Báo cáo</span>
                                    ...
                                    <ul class="sub-menu ">
                                        <li>
                                            <a href="#">
                                                <span class="text">1.Báo cáo tu?n v? ho?t d?ng môi tru?ng KCN</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <span class="text">2.Báo cáo tháng v? ho?t d?ng môi tru?ng KCN</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="page-knowledgebase.html">
                                                <span class="text">3.Báo cáo 6 tháng v? ho?t d?ng môi tru?ng KCN</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="page-inbox.html">
                                                <span class="text">4.Báo cáo môi tru?ng KCN</span>
                                            </a>
                                        </li>
                                        <li class="divider">
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="text">5.Báo cáo môi tru?ng t?ng h?p hàng nam c?a doanh nghi?</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="text">6.Báo cáo môi tru?ng 6 tháng c?a doanh nghi?p</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="text">7.Báo cáo quan tr?c môi tru?ng c?a doanh nghi?p</span>
                                            </a>
                                        </li>
                                        <li class="divider">
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="text">8.Báo cáo phí nu?c th?i</span>
                                            </a>
                                        </li>
                                        <li class="divider">
                                        </li>
                                        <li>
                                            <a href="#">
                                                <span class="text">Thi?t l?p thông s?</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="js-sub-menu-toggle"><i class="fa fa-clipboard fa-fw"></i><span class="text">Danh m?c</span>
                                    <i class="toggle-icon fa fa-angle-left"></i></a>
                                    <ul class="sub-menu ">
                                        <li>
                                            <a href="tailieu.html">
                                                <span class="text">Tài li?u</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="thongtinhuongdan.html">
                                                <span class="text">Thông tin hu?ng d?n</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="dieukhoan.html">
                                                <span class="text">Ði?u kho?n</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="luat.html">
                                                <span class="text">Lu?t b?o v? môi tru?ng</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
