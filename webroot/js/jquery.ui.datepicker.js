...
$.extend(Datepicker.prototype, {
        ...
        _dialogDatepicker: function(input, date, onSelect, settings, pos) {
                ...
                if (!this._pos) {
                        ...
                        var scrollX = $(document).scrollLeft() || $(body).scrollLeft();
                        var scrollY = $(document).scrollTop() || $(body).scrollTop();
        ...
        _showDatepicker: function(input) {
                ...
                if (!$.datepicker._pos) { // position below input
						...
						$.datepicker._pos[1] += input.offsetHeight + ($(document).scrollTop())
                }
                var isFixed = false;
                ...
                if (isFixed && $.browser.opera) { // correction for Opera when fixed and scrolled
                        $.datepicker._pos[0] -=$(document).scrollLeft();
                        $.datepicker._pos[1] -= $(document).scrollTop();
                }
