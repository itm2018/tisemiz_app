    ...
    <table class="taglib-search-iterator">
        <tbody>
            <tr class="portlet-section-header results-header">
                ...
                <th class="col-4 " style="min-width: 800px;">	<?php echo $this->Paginator->sort('tenvanban', 'Tóm tắt') ?>	</th>
                <th class="col-5 ">	Tải về	</th>
            </tr>
            ...
            <?php foreach ($data as $vanban): ?>
                <tr class="portlet-section-body results-row" onmouseover="this.className = 'portlet-section-body-hover results-row hover';" onmouseout="this.className = 'portlet-section-body results-row';">
                    ...
                    <td align="left" class="col-3" colspan="1" valign="middle">	<?php echo $vanban['Vanbanphapquy']['ngaybanhanh'] ? date('Y-m-d', strtotime($vanban['Vanbanphapquy']['ngaybanhanh'])) : '' ?></td>
                    <td align="left" class="col-4" colspan="1" valign="middle">	<a style="cursor:pointer;" href="<?php echo Router::url('/chitiet/vanbanphapquy/'.$vanban['Vanbanphapquy']['id'])?>"><?php echo $vanban['Vanbanphapquy']['tenvanban'] ?></a>	</td>
                    <td align="left" class="col-5" colspan="1" valign="middle">	<a onclick="doDownload(33,<?php echo $vanban['Vanbanphapquy']['id'] ?>);" target="_blank" href="<?php echo Router::url('/admin/vanbans/' . $vanban['Vanbanphapquy']['tenfile']) ?>"><img align="center" title="Download" src="<?php echo Router::url('/front/img/download.gif') ?>" ></a>	</td>
                </tr>
                <?php ++$i; ?>
            <?php endforeach; ?>
