...
<?php echo $this->Form->create('KhuCongNghiep'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Khu Cong Nghiep'); ?></legend>
	<?php
		echo $this->Form->input('colMa');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('KhuCongNghiep.colMa')), null, __('Are you sure you want to delete # %s?', $this->Form->value('KhuCongNghiep.colMa'))); ?></li>
