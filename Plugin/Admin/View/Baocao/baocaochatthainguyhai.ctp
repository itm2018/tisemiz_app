...
<script type="text/javascript">
    ...
    function PopUpCoSo(type) {
        ...
        var PPwindow2 = window.open("<?php echo Router::url('/admin/doanhnghiep/chucnang/type/'); ?>" + type + '/id_dn/' + madn, "_blank", "width=" + width + ",height=" + height + ",toolbar=no,directories=no,status=yes, menubar=no,scrollbars=yes,resizable=yes,border=thin,left=" + left + ",top=" + top + "screenX=" + left + ",screenY=" + top + "");
        PPwindow2.focus();
    }
