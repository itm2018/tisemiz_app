...
<table class="grid">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <?php echo $this->Form->input('phuonganxuly', array('div' => false, 'label' => false, 'id' => 'phuonganxuly', 'style' => 'width: 100px;', 'required' => 'required')) ?>
            </td>
            <td>
                <?php echo $this->Form->input('mucdoxuly', array('div' => false, 'label' => false, 'id' => 'mucdoxuly', 'style' => 'width: 100px;', 'required' => 'required')) ?>
            </td>
            <td>
                 <span>
        ...
        <tr>
            <td colspan="8"><?php echo $this->Form->button('Đóng', array('div' => false, 'label' => false, 'id' => 'btn-close', 'style' => 'width: 110px;', 'onclick' => 'javascript: window.opener.location.reload(); window.close();')) ?></td>
        </tr>
