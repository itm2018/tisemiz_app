                    ...
                    <tbody><tr>
                        ...
                        <tr>
                            <td colspan="2" align="left">
                                ...
                                <select name="drpCoso" onchange="javascript:setTimeout('__doPostBack(\'drpCoso\',\'\')', 0)" id="drpCoso">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td style="text-align: left;" bgcolor="#eff6f6">
                                                ...
                                                <input name="txtThuTuCTNH" type="text" value="4" id="txtThuTuCTNH" style="width:50px;">
                                            ...
                                            <td bgcolor="#eff6f6">
                                                <input name="txtSoLuongCTNH" type="text" value="1000" id="txtSoLuongCTNH" style="width:100%;text-align: right">
                                            </td>
                                            <td bgcolor="#eff6f6">
                        ...
                        <tr id="trAddEditCT">
                            <td align="left" style="width: 100%; padding-left: 6px; padding-right: 6px">
                                <input name="btnSelect" type="button" id="btnSelect" style="width: auto; height: 24px" value="Thêm CTNH phát sinh" onclick="javascript:doOpenDMCT('CTPS');">
                            </td>
                        </tr>
                                ...
                                <table class="grid" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr onmouseover="this.style.background = '#EEE0C5'" onmouseout="this.style.background = '#ffffff'" style="background: rgb(255, 255, 255);">
                                            ...
                                            <td align="right">100</td>
                                            <td>010101</td>
                                            <td><a href="javascript:updateItemTL('785789','Cặn thải có khả năng sinh axit từ quá trình chế biến quặng sunfua','Rắn/bùn','100','010101','4');">Sửa</a></td>
                                            <td><a href="javascript:doDelete1('785789','Cặn thải có khả năng sinh axit từ quá trình chế biến quặng sunfua','DangKyCNTID=785419&CosoID=785783')">Xóa</a></td>
                                        </tr>
                                        <tr onmouseover="this.style.background = '#EEE0C5'" onmouseout="this.style.background = '#ffffff'" style="background: rgb(255, 255, 255);">
                                            <td align="center"><b>5</b></td>
                                            <td>Các loại cặn thải khác có chứa các thành phần nguy hại</td>
                                            <td>Rắn/lỏng/bùn</td>
                                            <td align="right">100</td>
                                            <td>010102</td>
                                            <td><a href="javascript:updateItemTL('785790','Các loại cặn thải khác có chứa các thành phần nguy hại','Rắn/lỏng/bùn','100','010102','5');">Sửa</a></td>
                                            <td><a href="javascript:doDelete1('785790','Các loại cặn thải khác có chứa các thành phần nguy hại','DangKyCNTID=785419&CosoID=785783')">Xóa</a></td>
                                        </tr>
                                        <tr onmouseover="this.style.background = '#EEE0C5'" onmouseout="this.style.background = '#ffffff'">
                                            <td align="center"><b>6</b></td>
                                            <td>Chất thải có chứa các thành phần nguy hại từ quá trình chế biến quặng sắt</td>
                                            <td>Rắn/lỏng/bùn</td>
                                            <td align="right">100</td>
                                            <td>010103</td>
                                            <td><a href="javascript:updateItemTL('785791','Chất thải có chứa các thành phần nguy hại từ quá trình chế biến quặng sắt','Rắn/lỏng/bùn','100','010103','6');">Sửa</a></td>
                                            <td><a href="javascript:doDelete1('785791','Chất thải có chứa các thành phần nguy hại từ quá trình chế biến quặng sắt','DangKyCNTID=785419&CosoID=785783')">Xóa</a></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td style="text-align: left;" bgcolor="#eff6f6">
                                                ...
                                                <input name="txt_thutuTL" type="text" value="4" id="txt_thutuTL" style="width:50px;">
                                            ...
                                            <td bgcolor="#eff6f6">
                                                <input name="txt_soluongTL" type="text" value="1000" id="txt_soluongTL" style="width:100%;text-align: right">
                                            </td>
                                            <td bgcolor="#eff6f6">
                        ...
                        <tr id="tr1">
                            <td align="left" style="width: 100%; padding-left: 6px; padding-right: 6px">
                                <input name="Button2" type="button" id="Button2" style="width: auto; height: 24px" value="Thêm CTNH Tồn lưu" onclick="javascript:doOpenDMCT('CTTL');">
                            </td>
                        </tr>
                            ...
                            <td>
                                <table class="grid" id="Table5" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            <td>
                                                <input name="txtThuTuCS" type="text" value="1" id="txtThuTuCS" style="width:100%;">
                                                <input name="hidIDCS" type="hidden" id="hidIDCS">
                                            </td>
                                            <td>
                                                <input name="txtTenNhomCS" type="text" id="txtTenNhomCS" style="width:100%;" class="ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
                                            </td>
                                            <td>
                                                <input name="txtTrangThaiCs" type="text" id="txtTrangThaiCs" style="width:100%;">
                                            </td>
                                            <td>
                                                <input name="txtSoLuongCS" type="text" value="1000" id="txtSoLuongCS" style="width:100%;">
                                            </td>
                                            <td>
                                                <input name="txtMaCTNHCS" type="text" id="txtMaCTNHCS" style="width:100%;">
                                            </td>
                                            <td>
                                                <input name="txtPAXLCS" type="text" id="txtPAXLCS" style="width:100%;">
                                            </td>
                                            <td>
                                                <input name="txtMucDoXLCS" type="text" id="txtMucDoXLCS" style="width:100%;">
                                            </td>
                                            <td style="width: auto" align="center" colspan="2">
                                                <input name="Submit2" type="submit" id="Submit2" style="width: auto; height: 24px" onclick="KTCTCS(this)" value="Cập nhật">
                                            </td>
                                        </tr>
                                    </tbody></table>
                            </td>
