...
<?php echo $this->Form->create('DoanhNghiep'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Doanh Nghiep'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DoanhNghiep.colMa')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DoanhNghiep.colMa'))); ?></li>
