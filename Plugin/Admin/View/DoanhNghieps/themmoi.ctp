            ...
            <div class="tab-pane active" id="panel-1">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="inputTenDN" class="col-sm-2 control-label">Tên Doanh Nghiệp</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputTenDN" placeholder="tên doanh nghiệp">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputMasokd" class="col-sm-2 control-label">Mã số kinh doanh</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputMasokd" placeholder="mã số kinh doanh">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputDiachi" class="col-sm-2 control-label">Địa chỉ</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputDiachi" placeholder="địa chỉ doanh nghiệp">
                        </div>
                    </div>
                    <!--<div class="form-group">
