...
<table class="table">
    ...
    <tr>
        ...
        <td><?php echo $this->Form->input('tensanpham', array('div' => array('class' => 'col-sm-10'), 'label' => false, 'class' => 'form-control', 'type' => 'text', 'id' => 'txtTensanpham', 'placeholder' => 'nhập tên sản phẩm', 'value' => isset($sanpham) ? $sanpham['Sanpham']['tensanpham'] : '')); ?></td>
