<?php echo $this->Form->create('form1', array('method' => 'post')); ?>
    <table id="Table9" cellspacing="0" cellpadding="0" width="100%" border="0">
        <tbody><tr>
				...
				<td style="text-align: left;">
					<span id="lblTitle" style="font-family:Times New Roman;font-size:12pt;font-weight:bold;">Kết quả phân tích Công nghệ xử lý nước thải đang áp dụng</span>
				</td>
			</tr>
		</tbody></table>
