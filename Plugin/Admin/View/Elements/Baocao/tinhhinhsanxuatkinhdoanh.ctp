...
<table id="Table9" cellspacing="0" cellpadding="0" width="100%" border="0">
	<tbody><tr>
			...
			<td style="text-align: left;">
				<span id="lblTitle" style="font-family:Times New Roman;font-size:12pt;font-weight:bold;">Sản phẩm</span>
			</td>
		</tr>
	</tbody></table>


<table id="tabledata" cellspacing="0" cellpadding="0" width="100%" border="0" class="grid" style="margin-top: 20px;">
	<thead>
		<tr>
	...
	<tbody><tr onmouseover="this.style.background = '#dbf0c9'" onmouseout="this.style.background = '#ffffff'" style="background: rgb(255, 255, 255);">
		...
		if (!empty($tinhhinhsxkd)) {
			foreach($tinhhinhsxkd as $key => $thxskd) {
				?>	
				<tr onmouseover="this.style.background = '#dbf0c9'" onmouseout="this.style.background = '#ffffff'">
					<td align="center">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['stt']); ?>" id="ThuTu" name="ThuTu[]">
						<input type="hidden" style="width: 98%" value="<?php echo h($thxskd['temp_id']); ?>" id="ID" name="ID[]">
					</td>
					<td align="left">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['tensp']); ?>" id="Ten" name="Ten[]">
					</td>
					<td align="center">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['donvi']); ?>" id="DonVi" name="DonVi[]">
					</td>

					<td align="right">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['quy1']); ?>" name="T1[]">
					</td>

					<td align="right">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['quy2']); ?>" name="T2[]">
					</td>

					<td align="right">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['quy3']); ?>" name="T3[]">
					</td>

					<td align="right">
						<input type="text" style="width: 98%" value="<?php echo h($thxskd['quy4']); ?>" name="T4[]">
					</td>

					<td>
						<?php echo h(round($thxskd['tong'], 2)); ?>
					</td>

					<td align="center">
						<a href="javascript:doDelete(<?php echo h($thxskd['temp_id']); ?>,'');">Delete</a>
					</td>
				</tr>
			<?php
			}
