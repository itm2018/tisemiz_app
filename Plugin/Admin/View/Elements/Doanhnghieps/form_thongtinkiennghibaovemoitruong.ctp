...
<?php echo $this->Form->create('ThongTinKienNghiBvmt', array('method' => 'post', 'class' => 'form-horizontal', 'role' => 'form','id'=>'FormThongTinKienNghiBvmt')); ?>
...
<div class="form-group">
    ...
    <?php echo $this->Form->input('colKiennghi', array('div' => array('class' => 'col-sm-10'), 'label' => false, 'id' => 'inputKiennghi', 'type' => 'textarea')) ?>
</div>
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <?php if(isset($savingKiennghi) && count(array_values($savingKiennghi))):?>
